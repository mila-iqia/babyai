...
def main():
    ...
    current_num_evaluate, total_len, current_number_batch, fps = 0, 0, 0, 0.
    # Log dictionary
    ...
    while True:
        ...
        fps += update_end_time - update_start_time
        ...
        if should_evaluate:
            ...
            fps = total_len / total_len * 1.0
            
            logger.info(
                "U {} | FPS {:04.0f} | D {} | H {:.3f} | pL {: .3f} | A {: .3f}"
                    .format(current_num_evaluate, fps, duration,
            ...
            if args.tb:
                ...
                writer.add_scalar("validation_accuracy",val_log_all_task["accuracy"], current_num_evaluate)
