...
#  TODO: default 500 is too much, should be lower than the number of val demos, maybe take the MIN somewhere
...
def add_new_demos(args, il_learn):
    ...
    if not args.dagger:
        ...
        # TODO: seems like we should store args.model to restore it after this loading
...
def main(args):
    # TODO: Why fixed number? should be lower than number of demow BTW
    args.episodes = 50
    ...
    # TODO: use one logger defined outside of this, something like binary search. remove prints
