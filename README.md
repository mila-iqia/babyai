...
- PyQT5
- PyTorch 0.4+
- torch_rl ([repository](https://github.com/lcswillems/pytorch-a2c-ppo))
...
- `train_rl.py` is a script used to train a Reinforcement Learning agent, using the aforementioned `model.py`, and the RL algorithms implemented in [torch_rl](https://github.com/lcswillems/pytorch-a2c-ppo)
